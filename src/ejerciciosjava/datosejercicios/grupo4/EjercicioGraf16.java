 ...
 * @author Sistemas
 */
public class EjercicioGraf16 extends javax.swing.JFrame {

    /**
     * Creates new form EjercicioGraf12
     */
    public EjercicioGraf16() {
        int input = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjercicioGraf16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjercicioGraf16().setVisible(true);
            }
        });
    }
