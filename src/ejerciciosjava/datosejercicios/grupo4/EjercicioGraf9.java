 ...
 * @author Sistemas
 */
public class EjercicioGraf9 extends javax.swing.JFrame {

    /**
     * Creates new form EjercicioGraf12
     */
    public EjercicioGraf9() {
        int input = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjercicioGraf9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjercicioGraf9().setVisible(true);
            }
        });
    }
